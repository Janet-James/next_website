    ...
    var Flip = function(canvas,width,height,images,opts) {
      ...
      c.mousemove(function(e){
        ...
        if($(this).parent().parent().attr('id') == 'data1'){
         ...
         var link = document.createElement('a');
          link.href = 'product-dmrs.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data3'){
         var link = document.createElement('a');
          link.href = 'product-axis.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data4'){
         var link = document.createElement('a');
          link.href = 'product-pdms.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data5'){
         var link = document.createElement('a');
          link.href = 'product-fms.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data6'){
         var link = document.createElement('a');
          link.href = 'product-giaas.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data7'){
         var link = document.createElement('a');
          link.href = 'product-ncps.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data8'){
         var link = document.createElement('a');
          link.href = 'product-ntams.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data9'){
         var link = document.createElement('a');
          link.href = 'product-nlms.html';
          document.body.appendChild(link);
          link.click();    
        }
          
           else if($(this).parent().parent().attr('id') == 'data10'){
         var link = document.createElement('a');
          link.href = 'product-npms.html';
          document.body.appendChild(link);
          link.click();    
        }
          
          else if($(this).parent().parent().attr('id') == 'data11'){
         var link = document.createElement('a');
          link.href = 'product-idass.html';
          document.body.appendChild(link);
          link.click();    
        }
          
          else if($(this).parent().parent().attr('id') == 'data12'){
         var link = document.createElement('a');
          link.href = 'product-niaa.html';
          document.body.appendChild(link);
          link.click();    
        }
          
          else if($(this).parent().parent().attr('id') == 'data13'){
         var link = document.createElement('a');
          link.href = 'product-saaas.html';
          document.body.appendChild(link);
          link.click();    
        }
          
          else if($(this).parent().parent().attr('id') == 'data14'){
         var link = document.createElement('a');
          link.href = 'product-peaas.html';
          document.body.appendChild(link);
          link.click();    
        }
          
          else if($(this).parent().parent().attr('id') == 'data15'){
         var link = document.createElement('a');
          link.href = 'product-draas.html';
          document.body.appendChild(link);
          link.click();    
        }
